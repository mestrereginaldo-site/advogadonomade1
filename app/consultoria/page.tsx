...
export default function Consultoria() {
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const msg = `NOVO LEAD - Consultoria Premium%0A%0ANome: ${nome}%0AWhatsApp: ${whatsapp}`;
  ...
  return (
    <main className="min-h-screen bg-white text-black">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="border border-gray-300 rounded p-4 text-center">
            ...
            <ul className="text-sm text-left space-y-1 mb-4">
              <li>✅ 1 tema</li>
              <li>✅ Orientação escrita</li>
              <li>✅ 7 dias WhatsApp</li>
            </ul>
            <button onClick={() => window.open("https://wa.me/5588999999999?text=Quero%20Básico%20R%24197", "_blank")} className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded">
              Quero este
            </button>
          </div>
          ...
          <div className="border-2 border-green-500 rounded p-4 text-center bg-green-50">
            ...
            <ul className="text-sm text-left space-y-1 mb-4">
              <li>✅ 3 temas</li>
              <li>✅ Modelo personalizado</li>
              <li>✅ 14 dias WhatsApp</li>
              <li>✅ Revisão de doc</li>
            </ul>
            <button onClick={() => window.open("https://wa.me/5588999999999?text=Quero%20Intermediário%20R%24497", "_blank")} className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded">
              Quero este
            </button>
          </div>
          ...
          <div className="border border-gray-300 rounded p-4 text-center">
            ...
            <ul className="text-sm text-left space-y-1 mb-4">
              <li>✅ 30 dias ilimitado</li>
              <li>✅ Modelos personalizados</li>
              <li>✅ Suporte prioritário</li>
              <li>✅ Call 30 min</li>
            </ul>
            <button onClick={() => window.open("https://wa.me/5588999999999?text=Quero%20Premium%20R%24997", "_blank")} className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded">
              Quero este
            </button>
          </div>
        </div>
        ...
        {/* GARANTIA */}
        <div className="mt-8 max-w-md mx-auto p-3 bg-green-50 border border-green-200 rounded text-center">
          <p className="text-green-800 font-semibold text-sm">✅ 7 dias ou seu dinheiro de volta</p>
        </div>
      </div>
    </main>
  );
