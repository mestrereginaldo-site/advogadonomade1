      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="border border-gray-300 rounded p-4 text-center">
            ...
            <button onClick={() => window.open("https://wa.me/5588999999999?text=Quero%20Básico%20R%24197", "_blank")} className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded">Quero este</button>
          </div>
          ...
          <div className="border-2 border-green-500 rounded p-4 text-center bg-green-50">
            ...
            <button onClick={() => window.open("https://wa.me/5588999999999?text=Quero%20Intermediário%20R%24497", "_blank")} className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded">Quero este</button>
          </div>
          ...
          <div className="border border-gray-300 rounded p-4 text-center">
            ...
            <button onClick={() => window.open("https://wa.me/5588999999999?text=Quero%20Premium%20R%24997", "_blank")} className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded">Quero este</button>
          </div>
        </div>
