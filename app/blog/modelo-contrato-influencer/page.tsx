...
export default function Post() {
  ...
  <div className="max-w-3xl mx-auto prose prose-invert prose-green">
      ...
      <section className="prose prose-slate max-w-none">
        ...
        <Link
          href="/contratar"
          className="inline-block mt-2 bg-slate-800 hover:bg-slate-900 text-white font-semibold py-2 px-4 rounded"
        >
        ...
        <ul className="list-disc pl-6">
          <li>
            <Link className="underline" href="/blog/lgpd-para-ecommerce">
              LGPD para e-commerce: checklist rápido
            </Link>
          </li>
          <li>
            <Link className="underline" href="/blog/direito-autoral-reels">
