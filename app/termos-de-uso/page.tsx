  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-blue-900 mb-4">Termos de Uso</h1>
        <p className="mb-4 text-gray-600">Acesso em: {new Date().toLocaleDateString("pt-BR")}</p>

        <div className="prose prose-lg max-w-none text-gray-700">
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">1. Aceitação</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">2. Finalidade</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">3. Propriedade intelectual</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">4. Uso permitido</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">5. Limitação de responsabilidade</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">6. Links externos</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">7. Alterações</h2>
          <p className="mb-4">
            Podemos atualizar estes termos a qualquer momento. A data no topo indica a versão vigente.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">8. Legislação</h2>
          <p className="mb-4">
            Estes termos seguin as leis brasileiras. Qualquer controvérsia será resolvida no foro de Maceió/AL.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-2 text-blue-800">9. Contato</h2>
          <p>
            Dúvidas? Entre em contato via WhatsApp:{" "}
            <a href="https://wa.me/5571986482241" className="text-blue-600 underline">
              71 98648-2241
            </a>
          </p>
        </div>
